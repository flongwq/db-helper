...
/**
 ************************************************************
 * @类名 : ReadWriteSqlSessionFactory.java
 *
 * @DESCRIPTION :
 * @AUTHOR : flong
 * @DATE : 2015年12月16日
 ************************************************************
 */
public class ReadWriteSqlSessionFactory implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
    ...
    public void setDataSource(DataSource dataSource) {
        if (dataSource instanceof DataSourceRouter) {
            ...
            this.dataSource = router.determineTargetDataSource();
        }
    ...
    public void afterPropertiesSet() throws Exception {
        // notNull(dataSourceRouter, "Property 'dataSourceRouter' is required");
